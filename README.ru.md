...
Проект собирает историю моих постов из канала [Дронизм | Авторынок "Ереван"](https://t.me/dronizm), строит на их основе модель моего стиля письма и автоматически генерирует новые посты в этом стиле для канала-двойника — [Нейродронизм]. Перед публикацией каждый черновик проходит модерацию: бот присылает его мне в личку, и пост публикуется только после ручного одобрения.
